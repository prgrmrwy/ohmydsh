...
async function fixture() {
  ...
  const service = new ChannelService({
    ...
    // This fixture exercises pairing/consumer ownership, not capability
    // discovery. The merged Host now correctly fails formal enablement closed
    // unless the unified child/turn/read-policy seam is explicitly proven.
